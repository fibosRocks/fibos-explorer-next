...
import { ArrowLeft, ArrowRightLeft, Clock, Hash, FileText } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm mt-1">Transaction Details</p>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-6">
          <div className="grid gap-6">
            <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl">
              <Hash className="w-5 h-5 text-green-400 mt-1 shrink-0" />
              <div className="min-w-0">
                <p className="text-white/50 text-sm mb-1">交易 ID</p>
            ...
            <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl">
              ...
              <div>
                <p className="text-white/50 text-sm mb-1">交易数据</p>
                <p className="text-white/70">即将显示完整的 Actions、授权信息等</p>
              </div>
            </div>
          </div>
        </div>
